export const zhCN = {
  ...
  topSites: {
    loading: '正在加载常用网站…',
    empty: '暂无常用网站',
    listDescription: '由 Chrome 提供，保留浏览器的排序。',
    accessError: '未能更新常用网站设置或权限，请重试。',
    denied: '未获得授权，常用网站仍处于关闭状态。',
    unavailable: '请在 Chrome 扩展中开启常用网站。',
    description: '在侧边栏和搜索中显示常用网站。首次开启时需要授权。',
    title: '常用网站',
    hide: '隐藏“{{title}}”',
    restore: '恢复隐藏项（{{count}}）',
    saveError: '隐藏偏好未能保存，请重试。',
    privacy:
      '仅在开启并授权后读取 Chrome 提供的网站标题和网址，用于侧边栏和本机搜索；开关与隐藏的网址保存在本机，不上传。',
    error: '常用网站加载失败。',
    retry: '重试',
  },
  sync: {
